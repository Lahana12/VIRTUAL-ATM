...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(202, 247);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(187, 135);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(187, 187);
			...
			this->label2->Location = System::Drawing::Point(184, 171);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		this->Hide();
		random::second object_name_second;
