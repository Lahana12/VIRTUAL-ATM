...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pw->Location = System::Drawing::Point(197, 249);
			this->pw->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->pw->Name = L"pw";
			this->pw->Size = System::Drawing::Size(164, 26);
			this->pw->TabIndex = 38;
			...
			this->button1->Location = System::Drawing::Point(236, 307);
			...
			this->button3->Location = System::Drawing::Point(448, 421);
			...
			this->label1->Location = System::Drawing::Point(218, 218);
			...
			this->label6->Location = System::Drawing::Point(0, 98);
			this->label6->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(318, 23);
			this->label6->TabIndex = 43;
			this->label6->Text = L"New Password                      ";
			// 
			// pictureBox2
			// 
