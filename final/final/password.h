...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pw
			// 
			this->pw->Location = System::Drawing::Point(343, 259);
			this->pw->Name = L"pw";
			...
			this->label1->Location = System::Drawing::Point(141, 259);
			...
			this->label6->Location = System::Drawing::Point(2, 102);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(398, 22);
			this->label6->TabIndex = 43;
			this->label6->Text = L"Pasword entry for ATM use                                  ";
			// 
			// password
			// 
