...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Location = System::Drawing::Point(351, 435);
			...
			this->button3->Location = System::Drawing::Point(454, 435);
			...
			this->label6->Size = System::Drawing::Size(363, 26);
			this->label6->TabIndex = 20;
			this->label6->Text = L"Balance Check                     ";
			this->label6->Click += gcnew System::EventHandler(this, &balancecheck::label6_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(189, 230);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(177, 19);
			this->label1->TabIndex = 21;
			this->label1->Text = L"Your current balance is:";
			// 
			// current
			// 
			this->current->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->current->Location = System::Drawing::Point(193, 260);
			this->current->Margin = System::Windows::Forms::Padding(2);
			this->current->Name = L"current";
			this->current->ReadOnly = true;
			this->current->Size = System::Drawing::Size(170, 26);
