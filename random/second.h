...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(107, 54);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(44, 107);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(85, 37);
			this->button1->TabIndex = 1;
			this->button1->Text = L"Cash Withdrawl";
			...
			this->button2->Text = L"balance check";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &second::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(201, 173);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(75, 34);
			this->button3->TabIndex = 3;
			this->button3->Text = L"change password";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &second::button4_Click);
			// 
			// button4
			// 
			...
			this->button4->Text = L"Account inquiry";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &second::button3_Click);
			// 
			// second
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		this->Hide();
		random::withdraw object_name_second;
		object_name_second.ShowDialog();
		this->Show();
	}
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
	this->Hide();
	random::check object_name_second;
	object_name_second.ShowDialog();
	this->Show();
}
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	this->Hide();
	random::change object_name_second;
	object_name_second.ShowDialog();
	this->Show();
}
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
	this->Hide();
	random::account object_name_second;
	object_name_second.ShowDialog();
	this->Show();
}
};
